...
{
    public partial class frmShoesPorGenre : Form
    {
        public frmShoesPorGenre(IShoeService shoeService)
        {
            InitializeComponent();
        ...
        private void frmShoesPorGenre_Load(object sender, EventArgs e)
        {
        ...
        private void ActualizarListaPaginada()
        {
            ...
            shoeListDtos = _shoeService
                .GetListaPaginadaOrdenadaFiltrada(pageNum, pageSize, null, null,
                 null, GenreFiltro, null);
            MostrarDatosEnGRilla();
        }

        internal void SetDatosParaElPaginadoYFiltro(int _pageCount, int _pageNum, int _pageSize, int _recordCount, Genre? Genre)
        {
